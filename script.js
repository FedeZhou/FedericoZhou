...
window.addEventListener('scroll', () => {
    ...
    if (heroVisual && geometricShape && floatingElement) {
        geometricShape.style.transform = `translate(-50%, -50%) rotate(${scrolled * 0.1}deg)`;
        floatingElement.style.transform = `translateY(${scrolled * 0.05}px)`;
    }
});
